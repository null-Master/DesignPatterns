...
public class TestDrive {
    ...
    public void drive() {
        ...
        System.out.println("Interests set from owner v1.proxy");
        System.out.println(ownerProxy.getInterests());
...
//            e.printStackTrace();
            System.out.println("Can't set rating from owner v1.proxy");
        }
...
//            e.printStackTrace();
            System.out.println("Can't set interests from non owner v1.proxy");
        }

        nonOwnerProxy.setHotOrNotRating(3);
        System.out.println("Rating set from non owner v1.proxy");
